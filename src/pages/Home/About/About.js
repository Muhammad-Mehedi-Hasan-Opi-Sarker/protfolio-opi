...
const About = () => {
    return (
        <div className='mt-20 grid lg:grid-cols-2 sm:grid-cols-1 lg:px-32 px-4'>
            ...
            <div className='mt-3'>
                <h1 className='lg:text-4xl sm:text-6xl lg:font-extrabold font-bold lg:mt-4 text-primary lg:mb-5'>MEHEDI</h1>
                <h1 className='lg:text-4xl sm:text-6xl lg:font-extrabold font-bold lg:mt-4 text-primary lg:mb-5'>BANGLADESH</h1>
